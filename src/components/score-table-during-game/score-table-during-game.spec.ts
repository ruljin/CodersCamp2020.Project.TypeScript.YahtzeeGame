...
test('check rendering', () => {
  const table = createElementFromString(`<div class="score-table"><div id="scoreTableNames" class="score-table__names">
        ...
        </div><div class="score-table__players-container"><div class="score-table__player">
            <div class="score-table__player-name "><div class="rotate">Player 1</div></div>
              ...
              <div class="score-table__player-field score-table__player-field--blue "></div>
              <div class="score-table__player-field score-table__player-field--blue "></div>
            </div><div class="score-table__player">
